...
namespace model_BY_NM_single_sens_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 53, column 2 to column 36)",
                                                      ...
                                                      " (in 'string', line 116, column 4 to column 68)",
                                                      " (in 'string', line 118, column 4 to column 76)",
                                                      ...
                                                      " (in 'string', line 64, column 2 to column 12)",
                                                      ...
                                                      " (in 'string', line 71, column 2 to column 44)",
                                                      " (in 'string', line 72, column 2 to column 43)",
                                                      " (in 'string', line 74, column 2 to column 52)",
                                                      " (in 'string', line 76, column 2 to column 82)",
                                                      " (in 'string', line 80, column 4 to line 81, column 74)",
                                                      " (in 'string', line 84, column 4 to line 85, column 82)",
...
class model_BY_NM_single_sens final : public model_base_crtp<model_BY_NM_single_sens> {
private:
  int N;
  int P;
...
public:
  ~model_BY_NM_single_sens() { }
  
  inline std::string model_name() const final { return "model_BY_NM_single_sens"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_BY_NM_single_sens(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_BY_NM_single_sens_namespace::model_BY_NM_single_sens";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_BY_NM_single_sens_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
        ...
        "assigning variable gammaU");
      {
        ...
        for (int n = 1; n <= N; ++n) {
          ...
          ll_0 = ((((log_inv_logit(eta_yu0[(n - 1)]) * Y[(n - 1)]) +
                     (log1m_inv_logit(eta_yu0[(n - 1)]) * (1 - Y[(n - 1)])))
                    +
                    normal_lpdf<false>(M[(n - 1)], eta_mu0[(n - 1)], sigma_m))
                   + log1m_inv_logit(eta_u[(n - 1)]));
          current_statement__ = 61;
          ll_1 = ((((log_inv_logit((eta_yu0[(n - 1)] + alphaU)) * Y[(n - 1)])
                     +
                     (log1m_inv_logit((eta_yu0[(n - 1)] + alphaU)) *
                       (1 - Y[(n - 1)]))) +
                    normal_lpdf<false>(M[(n - 1)],
                      (eta_mu0[(n - 1)] + betaU), sigma_m)) +
                   log1m_inv_logit(eta_u[(n - 1)]));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_BY_NM_single_sens_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gamma\",\"type\":{\"name\":\"vector\",\"length\":" << 4 << "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" << alpha_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << beta_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"sigma_m\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"betaZ\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"transformed_parameters\"},{\"name\":\"betaU\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"betaA\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaZ\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"transformed_parameters\"},{\"name\":\"alphaU\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaA\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaM\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"gammaU\",\"type\":{\"name\":\"vector\",\"length\":" << 2 << "},\"block\":\"transformed_parameters\"},{\"name\":\"row_i\",\"type\":{\"name\":\"int\"},\"block\":\"generated_quantities\"},{\"name\":\"NDE_control\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NDE_treated\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NIE_control\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NIE_treated\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"TE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"ANDE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"ANIE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"M_a0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"M_a1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a1Ma0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a0Ma0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a1Ma1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a0Ma1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"U\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_BY_NM_single_sens_namespace::model_BY_NM_single_sens;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_BY_NM_single_sens_namespace::profiles__;
}
#endif
#endif
