...
#include "stanExports_NY_BM_single_sens.h"

RCPP_MODULE(stan_fit4NY_BM_single_sens_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_NY_BM_single_sens")
