...
namespace model_NY_NM_single_sens_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 52, column 2 to column 36)",
                                                      ...
                                                      " (in 'string', line 100, column 2 to column 23)",
                                                      " (in 'string', line 101, column 2 to column 23)",
                                                      ...
                                                      " (in 'string', line 113, column 2 to column 14)",
                                                      " (in 'string', line 116, column 4 to column 40)",
                                                      " (in 'string', line 118, column 4 to column 51)",
                                                      " (in 'string', line 120, column 4 to column 67)",
                                                      " (in 'string', line 122, column 4 to column 75)",
                                                      " (in 'string', line 124, column 4 to column 100)",
                                                      " (in 'string', line 125, column 4 to column 91)",
                                                      " (in 'string', line 127, column 4 to column 100)",
                                                      " (in 'string', line 128, column 4 to column 91)",
                                                      " (in 'string', line 130, column 4 to column 60)",
                                                      " (in 'string', line 131, column 4 to column 60)",
                                                      " (in 'string', line 133, column 4 to column 60)",
                                                      " (in 'string', line 134, column 4 to column 60)",
                                                      " (in 'string', line 135, column 4 to column 35)",
                                                      " (in 'string', line 136, column 4 to column 41)",
                                                      " (in 'string', line 137, column 4 to column 41)",
                                                      " (in 'string', line 114, column 17 to line 138, column 3)",
                                                      " (in 'string', line 114, column 2 to line 138, column 3)",
                                                      " (in 'string', line 61, column 9 to column 10)",
                                                      " (in 'string', line 61, column 2 to column 18)",
                                                      ...
                                                      " (in 'string', line 67, column 2 to column 12)",
                                                      " (in 'string', line 68, column 2 to column 12)",
                                                      " (in 'string', line 70, column 2 to column 22)",
                                                      " (in 'string', line 71, column 2 to column 34)",
                                                      " (in 'string', line 72, column 2 to column 50)",
                                                      " (in 'string', line 74, column 2 to column 44)",
                                                      " (in 'string', line 75, column 2 to column 43)",
                                                      " (in 'string', line 76, column 2 to column 52)",
                                                      " (in 'string', line 79, column 2 to column 82)",
                                                      " (in 'string', line 80, column 2 to column 82)",
                                                      " (in 'string', line 84, column 4 to line 85, column 74)",
                                                      " (in 'string', line 88, column 4 to line 89, column 83)",
                                                      " (in 'string', line 93, column 4 to column 38)",
                                                      " (in 'string', line 82, column 16 to line 94, column 3)",
                                                      " (in 'string', line 82, column 2 to line 94, column 3)",
                                                      ...
                                                      " (in 'string', line 13, column 10 to column 11)",
                                                      ...
                                                      " (in 'string', line 113, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_NY_NM_single_sens final : public model_base_crtp<model_NY_NM_single_sens> {
private:
  int N;
  int P;
...
public:
  ~model_NY_NM_single_sens() { }
  
  inline std::string model_name() const final { return "model_NY_NM_single_sens"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_NY_NM_single_sens(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_NY_NM_single_sens_namespace::model_NY_NM_single_sens";
    ...
    try {
      ...
      context__.validate_dims("data initialization","scale_sd_y","double",
          context__.to_vec());
      scale_sd_y = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 89;
      scale_sd_y = context__.vals_r("scale_sd_y")[(1 - 1)];
      current_statement__ = 89;
      current_statement__ = 89;
      check_greater_or_equal(function__, "scale_sd_y", scale_sd_y, 0);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_NY_NM_single_sens_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
        ...
        "assigning variable gammaU");
      {
        ...
        lp_accum__.add(
          (normal_lpdf<false>(sigma_y, 0, scale_sd_y) -
            normal_lcdf(0, 0, scale_sd_y)));
        ...
        for (int n = 1; n <= N; ++n) {
          ...
          ll_0 = ((normal_lpdf<false>(M[(n - 1)], eta_mu0[(n - 1)], sigma_m)
                    +
                    normal_lpdf<false>(Y[(n - 1)], eta_yu0[(n - 1)], sigma_y))
                   + log1m_inv_logit(eta_u[(n - 1)]));
          current_statement__ = 63;
          ll_1 = ((normal_lpdf<false>(M[(n - 1)], (eta_mu0[(n - 1)] + betaU),
                     sigma_m) +
                    normal_lpdf<false>(Y[(n - 1)],
                      (eta_yu0[(n - 1)] + alphaU), sigma_y)) +
                   log1m_inv_logit(eta_u[(n - 1)]));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_NY_NM_single_sens_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
      ...
      for (int n = 1; n <= N; ++n) {
        ...
        assign(M_a0, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            (multiply(
               ...
               betaZ) + (U[(n - 1)] * betaU)), sigma_m, base_rng__),
        ...
        assign(M_a1, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            ((multiply(
                rvalue(X, cons_list(index_uni(row_i), nil_index_list()), "X"),
                betaZ) + betaA) + (U[(n - 1)] * betaU)), sigma_m, base_rng__),
        ...
        assign(Y_a1Ma0, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            (((multiply(
              ...
              (U[(n - 1)] * alphaU)), sigma_y, base_rng__),
        ...
        assign(Y_a0Ma0, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            ...
            sigma_y, base_rng__), "assigning variable Y_a0Ma0");
        ...
        assign(Y_a0Ma1, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            ...
            sigma_y, base_rng__), "assigning variable Y_a0Ma1");
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gamma\",\"type\":{\"name\":\"vector\",\"length\":" << 4 << "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" << alpha_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << beta_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"sigma_m\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_y\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"betaZ\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"transformed_parameters\"},{\"name\":\"betaU\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"betaA\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaZ\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"transformed_parameters\"},{\"name\":\"alphaU\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaA\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaM\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"gammaU\",\"type\":{\"name\":\"vector\",\"length\":" << 2 << "},\"block\":\"transformed_parameters\"},{\"name\":\"row_i\",\"type\":{\"name\":\"int\"},\"block\":\"generated_quantities\"},{\"name\":\"NDE_control\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NDE_treated\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NIE_control\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NIE_treated\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"TE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"ANDE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"ANIE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"M_a0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"M_a1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a1Ma0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a0Ma0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a1Ma1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a0Ma1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"U\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_NY_NM_single_sens_namespace::model_NY_NM_single_sens;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_NY_NM_single_sens_namespace::profiles__;
}
#endif
#endif
