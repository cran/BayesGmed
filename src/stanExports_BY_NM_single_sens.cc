...
#include "stanExports_BY_NM_single_sens.h"

RCPP_MODULE(stan_fit4BY_NM_single_sens_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_BY_NM_single_sens")
