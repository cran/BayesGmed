...
namespace model_NY_NM_single_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'string', line 32, column 2 to column 22)",
                                                      ...
                                                      " (in 'string', line 44, column 2 to column 36)",
                                                      ...
                                                      " (in 'string', line 65, column 2 to column 23)",
                                                      " (in 'string', line 66, column 2 to column 23)",
                                                      " (in 'string', line 67, column 2 to column 14)",
                                                      " (in 'string', line 68, column 2 to column 16)",
                                                      " (in 'string', line 69, column 2 to column 16)",
                                                      " (in 'string', line 70, column 2 to column 17)",
                                                      ...
                                                      " (in 'string', line 78, column 4 to column 40)",
                                                      " (in 'string', line 80, column 4 to column 53)",
                                                      " (in 'string', line 82, column 4 to column 61)",
                                                      " (in 'string', line 84, column 4 to column 84)",
                                                      " (in 'string', line 85, column 4 to column 78)",
                                                      " (in 'string', line 87, column 4 to column 84)",
                                                      " (in 'string', line 88, column 4 to column 75)",
                                                      " (in 'string', line 90, column 4 to column 60)",
                                                      " (in 'string', line 91, column 4 to column 60)",
                                                      " (in 'string', line 93, column 4 to column 60)",
                                                      " (in 'string', line 94, column 4 to column 60)",
                                                      " (in 'string', line 95, column 4 to column 35)",
                                                      " (in 'string', line 96, column 4 to column 41)",
                                                      " (in 'string', line 97, column 4 to column 41)",
                                                      " (in 'string', line 76, column 17 to line 98, column 3)",
                                                      " (in 'string', line 76, column 2 to line 98, column 3)",
                                                      " (in 'string', line 50, column 2 to column 44)",
                                                      " (in 'string', line 51, column 2 to column 43)",
                                                      " (in 'string', line 53, column 2 to column 82)",
                                                      " (in 'string', line 54, column 2 to column 82)",
                                                      " (in 'string', line 56, column 2 to column 46)",
                                                      ...
                                                      " (in 'string', line 26, column 2 to column 46)",
...
class model_NY_NM_single final : public model_base_crtp<model_NY_NM_single> {
private:
  int N;
  int P;
...
public:
  ...
  inline std::string model_name() const final { return "model_NY_NM_single"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_NY_NM_single(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_NY_NM_single_namespace::model_NY_NM_single";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_NY_NM_single_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      alphaM = alpha[((P + 2) - 1)];
      {
        ...
        lp_accum__.add(
          multi_normal_lpdf<propto__>(alpha, location_m, scale_m));
        current_statement__ = 41;
        lp_accum__.add(multi_normal_lpdf<propto__>(beta, location_y, scale_y));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_NY_NM_single_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
      ...
      for (int n = 1; n <= N; ++n) {
        ...
        assign(Y_a1Ma0, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            ((multiply(
                rvalue(X, cons_list(index_uni(row_i), nil_index_list()), "X"),
                alphaZ) + (M_a0[(n - 1)] * alphaM)) + alphaA), sigma_y,
            base_rng__), "assigning variable Y_a1Ma0");
        current_statement__ = 28;
        assign(Y_a0Ma0, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            (multiply(
               rvalue(X, cons_list(index_uni(row_i), nil_index_list()), "X"),
               alphaZ) + (M_a0[(n - 1)] * alphaM)), scale_sd_y, base_rng__),
        ...
        assign(Y_a1Ma1, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            ((multiply(
                rvalue(X, cons_list(index_uni(row_i), nil_index_list()), "X"),
                alphaZ) + (M_a1[(n - 1)] * alphaM)) + alphaA), sigma_y,
            base_rng__), "assigning variable Y_a1Ma1");
        current_statement__ = 30;
        assign(Y_a0Ma1, cons_list(index_uni(n), nil_index_list()),
          normal_rng(
            (multiply(
               rvalue(X, cons_list(index_uni(row_i), nil_index_list()), "X"),
               alphaZ) + (M_a1[(n - 1)] * alphaM)), sigma_y, base_rng__),
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" << alpha_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << beta_1dim__ << "},\"block\":\"parameters\"},{\"name\":\"sigma_m\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_y\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"betaZ\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"transformed_parameters\"},{\"name\":\"betaA\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaZ\",\"type\":{\"name\":\"vector\",\"length\":" << P << "},\"block\":\"transformed_parameters\"},{\"name\":\"alphaA\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"alphaM\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"row_i\",\"type\":{\"name\":\"int\"},\"block\":\"generated_quantities\"},{\"name\":\"NDE_control\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NDE_treated\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NIE_control\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"NIE_treated\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"TE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"ANDE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"ANIE\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"M_a0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"M_a1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a1Ma0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a0Ma0\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a1Ma1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"},{\"name\":\"Y_a0Ma1\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_NY_NM_single_namespace::model_NY_NM_single;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_NY_NM_single_namespace::profiles__;
}
#endif
#endif
